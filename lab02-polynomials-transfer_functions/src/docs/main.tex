...
\subsection{Part 1 -- Poles and zeroes, Matlab Live Script}

\includepdf{part01_poles_zeros_mlx.pdf}

\subsection{Part 2 -- Laplace transforms, Matlab Live Script}

\includepdf{part02_laplace_transforms_mlx.pdf}
