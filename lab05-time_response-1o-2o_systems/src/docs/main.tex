...
\begin{enumerate}
    \item
        ...
        \begin{equation}
            ...
            \\*
                & {}={} & \exp\brao*{\dfrac{-\brao*{\sfrac{a}{\brao*{2\sqrt{b}}}}\pi}{\brao*{\frac{1}{2\sqrt{b}} \sqrt{4b - a^2}}}}\SI{100}\percent
            \\*
                & {}={} & \exp\brao*{\dfrac{-a\pi}{\sqrt{4b - a^2}}} \SI{100}\percent\rlap.
            \\*
            \end{array}
        \end{equation}
        ...
        \begin{equation}
            \tau_s \approx \frac4{\zeta\omega_n} = \frac4{\brao*{\sfrac{a}2}} = \frac8a.
        \end{equation}

        We find that the peak time
        \begin{equation}
            \tau_p = \frac\pi{\omega_n \sqrt{1 - \zeta^2}} = \frac\pi{\brao*{\sqrt{b}}\brao*{ \frac{1}{2\sqrt{b}}\sqrt{4b - a^2}}} = \frac{2\pi}{\sqrt{4b - a^2}}.
        \end{equation}
        ...
        Let's evaluate at $a = 4, b = 25$. Well $b = 25 > 0$ and $a = 4 < 10 = 2\sqrt{b}$. The overshoot rate
        \begin{equation}
                \% OS
                ={} \exp\brao*{\dfrac{-\brao4\pi}{\sqrt{4\brao{25} - \brao4^2}}} \SI{100}\percent = \siexpr{2\overline5.38}\percent.
        \end{equation}
        The setting time
        \begin{equation}
            \tau_s \approx \frac84 = \SI2\second.
        \end{equation}
        The peak time
        \begin{equation}
            \tau_p = \frac{2\pi}{\sqrt{4\brao{25} - \brao4^2}} = \siexpr{0.6\overline956}\second.
        \end{equation}
