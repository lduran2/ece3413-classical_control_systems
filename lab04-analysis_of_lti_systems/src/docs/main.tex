...
In Part 01a, we are modeling a step response. Thus, our input signal is a Heaviside step function as built in Fig. \ref{fig:step response model system}.
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{The model for the step response.}
	\label{fig:step response model step config}
\end{figure}
