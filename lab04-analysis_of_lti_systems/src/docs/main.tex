...
In\ref{fig:step - measuring rising time}, we already have an exact measure of the time when $c = 0.0200$.
...
So the we look for the last value where $c = c_f - \SI{5}\percent = \num{2.111e-2}$.
