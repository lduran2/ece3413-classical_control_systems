...
be warned that the installation will require escalation to Administrator previledges.
...
\begin{enumerate}
    ...
    \item
        \begin{figure}
            ...
            \caption{The ``Add-On Explorer'' dialog with ``Simulation Control Design'' hovered.}
