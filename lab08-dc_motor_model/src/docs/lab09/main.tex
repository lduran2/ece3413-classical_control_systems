...
\begin{enumerate}
    ...
    \item
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\linewidth]{intro_050_searching_installed_simulink_control_design.png}
    ...
    \item
        \begin{figure}
            \centering
            \includegraphics[width=\linewidth]{intro_030_selected_simulink_control_design.png}
    ...
    \item
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\linewidth]{intro_040_installed_simulink_control_design.png}
